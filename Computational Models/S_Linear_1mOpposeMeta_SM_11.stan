...
parameters {
  ...
  vector[nSubjects] meta_pr;  // slope for ingroup
...
model {
  ...
  for (s in 1:nSubjects) {
    ...
    GPout[1:nTrain[s]] = (1-(m[s]))-meta[s] * (prevSelf[s,1:nTrain[s]]/7);
